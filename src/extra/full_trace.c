...
inline Node3D* full_trace_node3d_new(const char *___file___, int ___line___, const char* name) {
    he_update_full_trace_info("node3d_new", ___file___, ___line___);
    Node3D* result = node3d_new(name);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Window* full_trace_window_new(const char *___file___, int ___line___, const char* name, const char* title, int w, int h) {
    he_update_full_trace_info("window_new", ___file___, ___line___);
    Window* result = window_new(name, title, w, h);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline void full_trace_window_set_title(const char *___file___, int ___line___, Window* this, const char* title) {
    he_update_full_trace_info("window_set_title", ___file___, ___line___);
    window_set_title(this, title);
    he_update_full_trace_info("", "", -1);
}

inline const char* full_trace_window_get_title(const char *___file___, int ___line___, const Window* this) {
    he_update_full_trace_info("window_get_title", ___file___, ___line___);
    const char* result = window_get_title(this);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline CanvasItem* full_trace_canvas_item_new(const char *___file___, int ___line___, const char* name) {
    he_update_full_trace_info("canvas_item_new", ___file___, ___line___);
    CanvasItem* result = canvas_item_new(name);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Control* full_trace_control_new(const char *___file___, int ___line___, const char* name) {
    he_update_full_trace_info("control_new", ___file___, ___line___);
    Control* result = control_new(name);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Viewport* full_trace_viewport_new(const char *___file___, int ___line___, const char* name) {
    he_update_full_trace_info("viewport_new", ___file___, ___line___);
    Viewport* result = viewport_new(name);
    he_update_full_trace_info("", "", -1);
    return result;
}
...
inline Vec2 full_trace_vec2_new(const char *___file___, int ___line___, float x, float y, float z) {
    he_update_full_trace_info("vec2_new", ___file___, ___line___);
    Vec2 result = vec2_new(x, y, z);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Vec2 full_trace_vec2_add(const char *___file___, int ___line___, const Vec2* const a, const Vec2* const b) {
    he_update_full_trace_info("vec2_add", ___file___, ___line___);
    Vec2 result = vec2_add(a, b);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Vec2 full_trace_vec2_sub(const char *___file___, int ___line___, const Vec2* const a, const Vec2* const b) {
    he_update_full_trace_info("vec2_sub", ___file___, ___line___);
    Vec2 result = vec2_sub(a, b);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Vec2 full_trace_vec2_scale(const char *___file___, int ___line___, const Vec2* const a, const float factor) {
    he_update_full_trace_info("vec2_scale", ___file___, ___line___);
    Vec2 result = vec2_scale(a, factor);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline float full_trace_vec2_dot(const char *___file___, int ___line___, const Vec2* const a, const Vec2* const b) {
    he_update_full_trace_info("vec2_dot", ___file___, ___line___);
    float result = vec2_dot(a, b);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline float full_trace_vec2_length(const char *___file___, int ___line___, const Vec2* const a) {
    he_update_full_trace_info("vec2_length", ___file___, ___line___);
    float result = vec2_length(a);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Vec2 full_trace_vec2_normalize(const char *___file___, int ___line___, const Vec2* const a) {
    he_update_full_trace_info("vec2_normalize", ___file___, ___line___);
    Vec2 result = vec2_normalize(a);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline float full_trace_vec2_distance(const char *___file___, int ___line___, const Vec2* const a, const Vec2* const b) {
    he_update_full_trace_info("vec2_distance", ___file___, ___line___);
    float result = vec2_distance(a, b);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline void full_trace_vec2_add_in(const char *___file___, int ___line___, Vec2* const to, const Vec2* const what) {
    he_update_full_trace_info("vec2_add_in", ___file___, ___line___);
    vec2_add_in(to, what);
    he_update_full_trace_info("", "", -1);
}

inline void full_trace_vec2_sub_in(const char *___file___, int ___line___, Vec2* const from, const Vec2* const what) {
    he_update_full_trace_info("vec2_sub_in", ___file___, ___line___);
    vec2_sub_in(from, what);
    he_update_full_trace_info("", "", -1);
}

inline void full_trace_vec2_scale_in(const char *___file___, int ___line___, Vec2* const to, const float factor) {
    he_update_full_trace_info("vec2_scale_in", ___file___, ___line___);
    vec2_scale_in(to, factor);
    he_update_full_trace_info("", "", -1);
}

inline void full_trace_vec2_normalize_in(const char *___file___, int ___line___, Vec2* const a) {
    he_update_full_trace_info("vec2_normalize_in", ___file___, ___line___);
    vec2_normalize_in(a);
    he_update_full_trace_info("", "", -1);
}
...
inline Error full_trace_window_server_register_backend(const char *___file___, int ___line___, const char* name, WindowServerBackend* backend) {
    he_update_full_trace_info("window_server_register_backend", ___file___, ___line___);
    Error result = window_server_register_backend(name, backend);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Error full_trace_window_server_load_backend(const char *___file___, int ___line___, const char* name) {
    he_update_full_trace_info("window_server_load_backend", ___file___, ___line___);
    Error result = window_server_load_backend(name);
    he_update_full_trace_info("", "", -1);
    return result;
}

inline WindowServerBackend* full_trace_window_server_backend_new(const char *___file___, int ___line___) {
    he_update_full_trace_info("window_server_backend_new", ___file___, ___line___);
    WindowServerBackend* result = window_server_backend_new();
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Error full_trace_window_server_backend_set_function(const char *___file___, int ___line___, 
        WindowServerBackend* backend, const char* name, void (*function)(void)
) {
    he_update_full_trace_info("window_server_backend_set_function", ___file___, ___line___);
    Error result = window_server_backend_set_function(backend, name, (*function)(void));
    he_update_full_trace_info("", "", -1);
    return result;
}
...
inline SurfaceBridgeBackend* full_trace_surface_bridge_backend_new(const char *___file___, int ___line___) {
    he_update_full_trace_info("surface_bridge_backend_new", ___file___, ___line___);
    SurfaceBridgeBackend* result = surface_bridge_backend_new();
    he_update_full_trace_info("", "", -1);
    return result;
}

inline Error full_trace_surface_bridge_backend_set_function(const char *___file___, int ___line___, 
        SurfaceBridgeBackend* backend, const char* name, void (*function)(void)
) {
    he_update_full_trace_info("surface_bridge_backend_set_function", ___file___, ___line___);
    Error result = surface_bridge_backend_set_function(backend, name, (*function)(void));
    he_update_full_trace_info("", "", -1);
    return result;
}
