 ...
 */
extern String * (*raw_string_new)(void);
 ...
 */
extern String * (*raw_string_set_cstr_len)(String * self, const char * c_str, const usize len_c_str);
 ...
 * @param c_str pointer on new content of String
 */
extern String * (*raw_string_set_cstr)(String * self, const char * c_str);
 ...
 */
extern String * (*raw_string_set)(String * self, const String * str);

/**
 * @api
 * @brief get String by way char*
 */
extern char * (*raw_string_cstr)(const String * self);
 ...
 */
extern String * (*raw_string_push_back)(String * self, const String * src);
 ...
 */
extern String * (*raw_string_push_back_cstr)(String * self, const char * src);
 ...
 * @param src  String that need to add
 */
extern String * (*raw_string_push_front)(String * self, const String * src);
 ...
 * @param src  char* that need to add
 */
extern String * (*raw_string_push_front_cstr)(String * self, const char * src);
 ...
 */
extern String * (*raw_string_insert)(String * self, const String * src, const usize i);
 ...
 * @param i   symbol index
 */
extern String * (*raw_string_insert_cstr)(String * self, const char * src, const usize i);
 ...
 * @param b   byte index
 */
extern String * (*raw_string_insert_cstr_by_byte)(String * self, const char * src, const usize b);
 ...
 * @param b   byte index
 */
extern String * (*raw_string_insert_by_byte)(String * self, const String * src, const usize b);
 ...
 */
extern boolean (*raw_string_equals_cstr)(const String * str, const char * c_str);

/**
 * @api
 * @brief free memory of passed String
 */
extern void (*raw_string_free)(String * self);
 ...
 * @param e end point
 */
extern StringSlice * (*raw_string_get_slice)(const String * self, const usize s, const usize e);

/**
 * @api
 * @brief String from StringSlice
 */
extern String * (*raw_string_from_slice)(const StringSlice * self);
 ...
 */
extern boolean (*raw_string_equals_slice)(StringSlice * str_sl_1, StringSlice * str_sl_2);
 ...
 */
extern StringSlice * (*raw_string_set_slice)(StringSlice * self, const StringSlice * str_sl);
 ...
 */
extern String * (*raw_string_push_back_slice)(String * self, const StringSlice * src);
 ...
 * @param src StringSlice that will be added
 */
extern String * (*raw_string_push_front_slice)(String * self, const StringSlice * src);
 ...
 * @param i   symbol index
 */
extern String * (*raw_string_insert_slice)(String * self, const StringSlice * src, const usize i);
 ...
 * @param b   byte index
 */
extern String * (*raw_string_insert_slice_by_byte)(String * self, const StringSlice * src, const usize b);

/**
 * @api
 * @brief free memory of passed StringSLice
 */
extern void (*raw_string_slice_free)(StringSlice * self);
 ...
 * @param len_c_str len of c_str
 */
extern String * (*string_set_cstr_len)(String * self, const char * c_str, const usize len_c_str);
 ...
 * @param c_str pointer on new content of String
 */
extern String * (*string_set_cstr)(String * self, const char * c_str);
 ...
 * @param str  copied String
 */
extern String * (*string_set)(String * self, const String * str);

/**
 * @api
 * @brief get String by way char*
 */
extern char * (*string_cstr)(const String * self);
 ...
 * @param src  String that need to add
 */
extern String * (*string_push_back)(String * self, const String * src);
 ...
 * @param src  char* that need to add
 */
extern String * (*string_push_back_cstr)(String * self, const char * src);
 ...
 * @param src  String that need to add
 */
extern String * (*string_push_front)(String * self, const String * src);
 ...
 * @param src  char* that need to add
 */
extern String * (*string_push_front_cstr)(String * self, const char * src);
 ...
 * @param i   symbol index
 */
extern String * (*string_insert)(String * self, const String * src, const usize i);
 ...
 * @param i   symbol index
 */
extern String * (*string_insert_cstr)(String * self, const char * src, const usize i);
 ...
 * @param b   byte index
 */
extern String * (*string_insert_cstr_by_byte)(String * self, const char * src, const usize b);
 ...
 * @param b   byte index
 */
extern String * (*string_insert_by_byte)(String * self, const String * src, const usize b);
 ...
 * @param c_str checking char*
 */
extern boolean (*string_equals_cstr)(const String * str, const char * c_str);
 ...
 * @param e end point
 */
extern StringSlice * (*string_get_slice)(const String * self, const usize s, const usize e);

/**
 * @api
 * @brief String from StringSlice
 */
extern String * (*string_from_slice)(const StringSlice * self);
 ...
 * @param str_sl_2 second StringSlice
 */
extern boolean (*string_equals_slice)(StringSlice * str_sl_1, StringSlice * str_sl_2);
 ...
 * @param str_sl StringSLice which from take data
 */
extern StringSlice * (*string_set_slice)(StringSlice * self, const StringSlice * str_sl);
 ...
 * @param src StringSlice that will be added
 */
extern String * (*string_push_back_slice)(String * self, const StringSlice * src);
 ...
 * @param src StringSlice that will be added
 */
extern String * (*string_push_front_slice)(String * self, const StringSlice * src);
 ...
 * @param i   symbol index
 */
extern String * (*string_insert_slice)(String * self, const StringSlice * src, const usize i);
 ...
 * @param b   byte index
 */
extern String * (*string_insert_slice_by_byte)(String * self, const StringSlice * src, const usize b);

/**
 * @api
 * @brief free memory of passed StringSLice
 */
extern void (*string_slice_free)(StringSlice * self);
...
extern boolean (*window_server_window_get_position)(WindowServerWindow * this, IVec2 * out);
    ...
    String * (*raw_string_new)(void);
    String * (*raw_string_from)(const char * c_str);
    String * (*raw_string_clone)(const String * c_str);
    String * (*raw_string_set_cstr_len)(String * self, const char * c_str, const usize len_c_str);
    String * (*raw_string_set_cstr)(String * self, const char * c_str);
    String * (*raw_string_set)(String * self, const String * str);
    char * (*raw_string_cstr)(const String * self);
    usize (*raw_string_len)(const String * c_str);
    usize (*raw_string_size)(const String * c_str);
    String * (*raw_string_push_back)(String * self, const String * src);
    String * (*raw_string_push_back_cstr)(String * self, const char * src);
    String * (*raw_string_push_front)(String * self, const String * src);
    String * (*raw_string_push_front_cstr)(String * self, const char * src);
    String * (*raw_string_insert)(String * self, const String * src, const usize i);
    String * (*raw_string_insert_cstr)(String * self, const char * src, const usize i);
    String * (*raw_string_insert_cstr_by_byte)(String * self, const char * src, const usize b);
    String * (*raw_string_insert_by_byte)(String * self, const String * src, const usize b);
    ...
    boolean (*raw_string_equals_cstr)(const String * str, const char * c_str);
    void (*raw_string_free)(String * self);
    StringSlice * (*raw_string_get_slice)(const String * self, const usize s, const usize e);
    String * (*raw_string_from_slice)(const StringSlice * self);
    boolean (*raw_string_equals_slice)(StringSlice * str_sl_1, StringSlice * str_sl_2);
    StringSlice * (*raw_string_set_slice)(StringSlice * self, const StringSlice * str_sl);
    String * (*raw_string_push_back_slice)(String * self, const StringSlice * src);
    String * (*raw_string_push_front_slice)(String * self, const StringSlice * src);
    ...
    void ___hate_engine_runtime_init(void* (*proc_addr)(const char* name)) {
        ...
        raw_string_new = (String * (*)(void))proc_addr("string_new");
        raw_string_from = (String * (*)(const char *))proc_addr("string_from");
        raw_string_clone = (String * (*)(const String *))proc_addr("string_clone");
        raw_string_set_cstr_len = (String * (*)(String *, const char *, const usize))proc_addr("string_set_cstr_len");
        ...
        raw_string_get_slice = (StringSlice * (*)(const String *, const usize, const usize))proc_addr("string_get_slice");
        raw_string_from_slice = (String * (*)(const StringSlice *))proc_addr("string_from_slice");
        raw_string_equals_slice = (boolean (*)(StringSlice *, StringSlice *))proc_addr("string_equals_slice");
        raw_string_set_slice = (StringSlice * (*)(StringSlice *, const StringSlice *))proc_addr("string_set_slice");
        raw_string_push_back_slice = (String * (*)(String *, const StringSlice *))proc_addr("string_push_back_slice");
        raw_string_push_front_slice = (String * (*)(String *, const StringSlice *))proc_addr("string_push_front_slice");
        ...
        raw_vfs_stream_close = (void (*)(FileStream *))proc_addr("vfs_stream_close");
            ...
            string_set_cstr_len = raw_string_set_cstr_len;
...
String * full_trace_string_new(const char* ___file___, uint32_t ___line___);
...
String * full_trace_string_set_cstr_len(const char* ___file___, uint32_t ___line___, String *, const char *, const usize);
...
StringSlice * full_trace_string_get_slice(const char* ___file___, uint32_t ___line___, const String *, const usize, const usize);
String * full_trace_string_from_slice(const char* ___file___, uint32_t ___line___, const StringSlice *);
boolean full_trace_string_equals_slice(const char* ___file___, uint32_t ___line___, StringSlice *, StringSlice *);
StringSlice * full_trace_string_set_slice(const char* ___file___, uint32_t ___line___, StringSlice *, const StringSlice *);
String * full_trace_string_push_back_slice(const char* ___file___, uint32_t ___line___, String *, const StringSlice *);
String * full_trace_string_push_front_slice(const char* ___file___, uint32_t ___line___, String *, const StringSlice *);
...
inline String * full_trace_string_new(const char* ___file___, uint32_t ___line___) {
    raw___he_update_full_trace_info("string_new", ___file___, ___line___);
    String * result = raw_string_new();
    raw___he_update_full_trace_info("", "", -1);
    return result;
}
...
inline String * full_trace_string_set_cstr_len(const char* ___file___, uint32_t ___line___, String * self, const char * c_str, const usize len_c_str) {
    raw___he_update_full_trace_info("string_set_cstr_len", ___file___, ___line___);
    String * result = raw_string_set_cstr_len(self, c_str, len_c_str);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_set_cstr(const char* ___file___, uint32_t ___line___, String * self, const char * c_str) {
    raw___he_update_full_trace_info("string_set_cstr", ___file___, ___line___);
    String * result = raw_string_set_cstr(self, c_str);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_set(const char* ___file___, uint32_t ___line___, String * self, const String * str) {
    raw___he_update_full_trace_info("string_set", ___file___, ___line___);
    String * result = raw_string_set(self, str);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline char * full_trace_string_cstr(const char* ___file___, uint32_t ___line___, const String * self) {
    raw___he_update_full_trace_info("string_cstr", ___file___, ___line___);
    char * result = raw_string_cstr(self);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}
...
inline String * full_trace_string_push_back(const char* ___file___, uint32_t ___line___, String * self, const String * src) {
    raw___he_update_full_trace_info("string_push_back", ___file___, ___line___);
    String * result = raw_string_push_back(self, src);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_push_back_cstr(const char* ___file___, uint32_t ___line___, String * self, const char * src) {
    raw___he_update_full_trace_info("string_push_back_cstr", ___file___, ___line___);
    String * result = raw_string_push_back_cstr(self, src);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_push_front(const char* ___file___, uint32_t ___line___, String * self, const String * src) {
    raw___he_update_full_trace_info("string_push_front", ___file___, ___line___);
    String * result = raw_string_push_front(self, src);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_push_front_cstr(const char* ___file___, uint32_t ___line___, String * self, const char * src) {
    raw___he_update_full_trace_info("string_push_front_cstr", ___file___, ___line___);
    String * result = raw_string_push_front_cstr(self, src);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_insert(const char* ___file___, uint32_t ___line___, String * self, const String * src, const usize i) {
    raw___he_update_full_trace_info("string_insert", ___file___, ___line___);
    String * result = raw_string_insert(self, src, i);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_insert_cstr(const char* ___file___, uint32_t ___line___, String * self, const char * src, const usize i) {
    raw___he_update_full_trace_info("string_insert_cstr", ___file___, ___line___);
    String * result = raw_string_insert_cstr(self, src, i);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_insert_cstr_by_byte(const char* ___file___, uint32_t ___line___, String * self, const char * src, const usize b) {
    raw___he_update_full_trace_info("string_insert_cstr_by_byte", ___file___, ___line___);
    String * result = raw_string_insert_cstr_by_byte(self, src, b);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_insert_by_byte(const char* ___file___, uint32_t ___line___, String * self, const String * src, const usize b) {
    raw___he_update_full_trace_info("string_insert_by_byte", ___file___, ___line___);
    String * result = raw_string_insert_by_byte(self, src, b);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}
...
inline boolean full_trace_string_equals_cstr(const char* ___file___, uint32_t ___line___, const String * str, const char * c_str) {
    raw___he_update_full_trace_info("string_equals_cstr", ___file___, ___line___);
    boolean result = raw_string_equals_cstr(str, c_str);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline void full_trace_string_free(const char* ___file___, uint32_t ___line___, String * self) {
    raw___he_update_full_trace_info("string_free", ___file___, ___line___);
    raw_string_free(self);
    raw___he_update_full_trace_info("", "", -1);
}

inline StringSlice * full_trace_string_get_slice(const char* ___file___, uint32_t ___line___, const String * self, const usize s, const usize e) {
    raw___he_update_full_trace_info("string_get_slice", ___file___, ___line___);
    StringSlice * result = raw_string_get_slice(self, s, e);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_from_slice(const char* ___file___, uint32_t ___line___, const StringSlice * self) {
    raw___he_update_full_trace_info("string_from_slice", ___file___, ___line___);
    String * result = raw_string_from_slice(self);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline boolean full_trace_string_equals_slice(const char* ___file___, uint32_t ___line___, StringSlice * str_sl_1, StringSlice * str_sl_2) {
...
inline StringSlice * full_trace_string_set_slice(const char* ___file___, uint32_t ___line___, StringSlice * self, const StringSlice * str_sl) {
    raw___he_update_full_trace_info("string_set_slice", ___file___, ___line___);
    StringSlice * result = raw_string_set_slice(self, str_sl);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_push_back_slice(const char* ___file___, uint32_t ___line___, String * self, const StringSlice * src) {
    raw___he_update_full_trace_info("string_push_back_slice", ___file___, ___line___);
    String * result = raw_string_push_back_slice(self, src);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_push_front_slice(const char* ___file___, uint32_t ___line___, String * self, const StringSlice * src) {
    raw___he_update_full_trace_info("string_push_front_slice", ___file___, ___line___);
    String * result = raw_string_push_front_slice(self, src);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_insert_slice(const char* ___file___, uint32_t ___line___, String * self, const StringSlice * src, const usize i) {
    raw___he_update_full_trace_info("string_insert_slice", ___file___, ___line___);
    String * result = raw_string_insert_slice(self, src, i);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline String * full_trace_string_insert_slice_by_byte(const char* ___file___, uint32_t ___line___, String * self, const StringSlice * src, const usize b) {
    raw___he_update_full_trace_info("string_insert_slice_by_byte", ___file___, ___line___);
    String * result = raw_string_insert_slice_by_byte(self, src, b);
    raw___he_update_full_trace_info("", "", -1);
    return result;
}

inline void full_trace_string_slice_free(const char* ___file___, uint32_t ___line___, StringSlice * self) {
    raw___he_update_full_trace_info("string_slice_free", ___file___, ___line___);
    raw_string_slice_free(self);
    raw___he_update_full_trace_info("", "", -1);
}
...
#define string_new() full_trace_string_new(__FILE__, __LINE__)
...
#define string_set_cstr_len(self, c_str, len_c_str) full_trace_string_set_cstr_len(__FILE__, __LINE__, self, c_str, len_c_str)
#define string_set_cstr(self, c_str) full_trace_string_set_cstr(__FILE__, __LINE__, self, c_str)
#define string_set(self, str) full_trace_string_set(__FILE__, __LINE__, self, str)
#define string_cstr(self) full_trace_string_cstr(__FILE__, __LINE__, self)
...
#define string_push_back(self, src) full_trace_string_push_back(__FILE__, __LINE__, self, src)
#define string_push_back_cstr(self, src) full_trace_string_push_back_cstr(__FILE__, __LINE__, self, src)
#define string_push_front(self, src) full_trace_string_push_front(__FILE__, __LINE__, self, src)
#define string_push_front_cstr(self, src) full_trace_string_push_front_cstr(__FILE__, __LINE__, self, src)
#define string_insert(self, src, i) full_trace_string_insert(__FILE__, __LINE__, self, src, i)
#define string_insert_cstr(self, src, i) full_trace_string_insert_cstr(__FILE__, __LINE__, self, src, i)
#define string_insert_cstr_by_byte(self, src, b) full_trace_string_insert_cstr_by_byte(__FILE__, __LINE__, self, src, b)
#define string_insert_by_byte(self, src, b) full_trace_string_insert_by_byte(__FILE__, __LINE__, self, src, b)
...
#define string_equals_cstr(str, c_str) full_trace_string_equals_cstr(__FILE__, __LINE__, str, c_str)
#define string_free(self) full_trace_string_free(__FILE__, __LINE__, self)
#define string_get_slice(self, s, e) full_trace_string_get_slice(__FILE__, __LINE__, self, s, e)
#define string_from_slice(self) full_trace_string_from_slice(__FILE__, __LINE__, self)
...
#define string_push_back_slice(self, src) full_trace_string_push_back_slice(__FILE__, __LINE__, self, src)
#define string_push_front_slice(self, src) full_trace_string_push_front_slice(__FILE__, __LINE__, self, src)
